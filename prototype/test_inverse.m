...
% Compute forward kinematics to get position
x = r * cosd(target_angles(1));
y = r * sind(target_angles(1));
z = B*sind(target_angles(2)) + C*sind(target_angles(2)+target_angles(3));
