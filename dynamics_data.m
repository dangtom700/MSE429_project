...
Link1.PAI = [0.16, -0.01, 0.99; % Ix
             -0.99, 0.01, 0.16;  % Iy
             -0.01, -1.00, -0.01]; % Iz
Link1.PMI = [119720.15, 364493.75, 383151.27];

% Coordinate 1
Link1.com_1 = [4.90, 1.77, 59.45];
Link1.MICOM_1 = [358222.61, -396.84, 38675.05;
                 -396.84, 383138.34, -1757369;
                 38675.05, -1757.69, 126004.21];
Link1.MICS_1 = [1082296.13, 1379.86, 98267.34;
                1379.86, 1111477.70, 19810.83;
                98267.34, 19810.83, 126004.15];

% Coordinate 2
Link1.com_2 = [-45.61, 1.75, -37.86];
Link1.MICOM_2 = [358222.19, -383.32, 38676.00;
                 -383.32, 383138.76, -1736.71;
                 38676.00, -1736.71, 126004.21];
Link1.MICS_2 = [652250.05, -16699.79, 392137.10;
                -16699.79, 1102354.73, -15280.75;
                392137.10, -15280.75, 552442.76];

% Coordinate 3
Link1.com_3 = [5.96, -127.92, -37.86];
Link1.MICOM_3 = [358222.19, -383.32, 38676.00;
                 -383.32, 383138.76, -1736.71;
                 38676.00, -1736.71, 126004.21];
Link1.MICS_3 = [4001678.94, -156566.32, -7545.06;
...
Link2.PAI = [0.15, -0.99, 0.00; % Ix
             0.99, 0.15, -0.07;  % Iy
             0.07, 0.01, 1.00];  % Iz
Link2.PMI = [48797.36, 224964.61, 242225.00];

% Coordinate 1
Link2.com_1 = [39.15, 105.49, 97.09];
Link2.MICOM_1 = [221203.36, -25729.69, -1140.25;
                 -25729.69, 52637.13, -228.09;
                 -1140.25, -228.09, 242146.48];
Link2.MICS_1 = [2456327.37, 423355.05, 412169.58;
                423355.05, 1244297.47, 1113494.27;
                412169.58, 1113494.27, 1618926.56];

% Coordinate 2
Link2.com_2 = [-11.41, 105.48, -0.21];
Link2.MICOM_2 = [221175.40, -25820.72, -1140.13;
                 -25820.72, 52665.09, -228.71;
                 -1140.13, -228.71, 242146.48];
Link2.MICS_2 = [1431160.62, -156714.28, -873.47;
                -156714.28, 66829.95, -2693.72;
                -873.47, -2693.72, 242146.48];

% Coordinate 3
Link2.com_3 = [40.16, -24.18, -0.21];
Link2.MICOM_3 = [221175.40, -25820.72, -1140.13;
                 -25820.72, 52665.09, -228.71;
                 -1140.13, -228.71, 242146.48];
Link2.MICS_3 = [284781.21, -131433.29, -2078.58;
...
Link3.PAI = [-0.01, -1.00, 0.00; % Ix
             0.00, 0.00, -1.00;  % Iy
             1.00, -0.01, 0.00];  % Iz
Link3.PMI = [3726.42, 62803.60, 65037.03];

% Coordinate 1
Link3.com_1 = [0.99, 192.35, 97.30];
Link3.MICOM_1 = [65033.44, 469.32, 1.59;
                 469.32, 3730.02, -9.38;
                 1.59, -9.38, 62803.60];
Link3.MICS_1 = [1761356.68, 7418.41, 3516.66;
                7418.41, 349368.75, 683227.73;
                3516.66, -9.38, 62803.60];

% Coordinate 2
Link3.com_2 = [-49.62, 192.32, -0.01];
Link3.MICOM_2 = [65033.93, 436.06, 1.59;
                 436.06, 3729.52, -9.38;
                 1.59, -9.38, 62803.60];
Link3.MICS_2 = [1415376.59, -347937.85, 12.50;
                -347937.85, 93606.25, -51.64;
                12.50, -51.64, 1503022.99];

% Coordinate 3
Link3.com_3 = [1.95, 62.65, -0.01];
Link3.MICOM_3 = [65033.93, 436.06, 1.59;
                 436.06, 3729.52, -9.38;
                 1.59, -9.38, 62803.60];
Link3.MICS_3 = [208342.71, 4903.82, 1.16;
